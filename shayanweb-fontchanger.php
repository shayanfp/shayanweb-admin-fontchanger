...
//
define( 'SHAYANWEB_FONT_CHANGER_VERSION' , '1.11' );
...
//
//
function shayanweb_fontchanger_init_logic() {
    load_plugin_textdomain('shayanweb-admin-fontchanger', false, dirname(plugin_basename(__FILE__)) . '/languages');
...
add_action('plugins_loaded', 'shayanweb_fontchanger_init_logic');
//
